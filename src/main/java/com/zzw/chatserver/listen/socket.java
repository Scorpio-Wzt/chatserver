...
//            }
//
//            logger.info("收到消息确认，userId={}, messageIds={}",
//                    confirmVo.getUserId(), confirmVo.getMessageIds());
//
//            // 标记单聊消息为已读
...
//                    groupMessageService.markGroupMessagesAsRead(entry.getKey(), confirmVo.getUserId(), entry.getValue());
//                }
//            }
//        } catch (Exception e) {
